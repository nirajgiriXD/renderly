  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select
          value={form.messages.apps.enableMultipleSelection}
          onValueChange={(value) => handleFormChange("enableMultipleSelection", value)}
        >
      ...
      <div className="grid grid-cols-2 gap-3">
        {APPS.messages.map((app) => {
          const isSelected = form.messages.apps.selectedApps[app.value];
          return (
            <Label
              key={app.value}
